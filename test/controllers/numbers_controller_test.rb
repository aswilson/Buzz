...
class NumbersControllerTest < ActionController::TestCase
  ...
  test "should create number" do
    assert_difference('Number.count') do
      post :create, number: { active: @number.active, full_number: @number.full_number, id: @number.id, type: @number.type }
    end
  ...
  test "should update number" do
    patch :update, id: @number, number: { active: @number.active, full_number: @number.full_number, id: @number.id, type: @number.type }
    assert_redirected_to number_path(assigns(:number))
  end
