...
class RemindersControllerTest < ActionController::TestCase
  ...
  test "should create reminder" do
    assert_difference('Reminder.count') do
      post :create, reminder: { contact_id: @reminder.contact_id, id: @reminder.id, pending: @reminder.pending, received: @reminder.received, user_id: @reminder.user_id, when: @reminder.when }
    end
  ...
  test "should update reminder" do
    patch :update, id: @reminder, reminder: { contact_id: @reminder.contact_id, id: @reminder.id, pending: @reminder.pending, received: @reminder.received, user_id: @reminder.user_id, when: @reminder.when }
    assert_redirected_to reminder_path(assigns(:reminder))
  end
